...
try {
    ...
    // Make db and app available globally
    window.db = db;
...
// Function to get goals for a specific date
async function getGoalsForDate(date) {
    try {
        ...
        // Query the goals collection directly as per your rules
